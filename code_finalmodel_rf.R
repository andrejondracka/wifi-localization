...
valdata$BUILDINGID <- factor(valdata$BUILDINGID, levels = c(2,1,0))
traindata$FLOOR <- factor(traindata$FLOOR)
traindata$BUILDINGID <- factor(traindata$BUILDINGID, levels = c(2,1,0))
...
h2o_gbm_lat_b2 <- h2o.randomForest(x = predictornames, y = 'LATITUDE', training_frame = h2o_train_bybuilding_list$`2`, 
                                   validation_frame = h2o_val_bybuilding_list$`2`, ntrees = 200, max_depth = 50)
h2o_gbm_lat_b0 <- h2o.randomForest(x = predictornames, y = 'LATITUDE', training_frame = h2o_train_bybuilding_list$`0`, 
                                   validation_frame = h2o_val_bybuilding_list$`0`, ntrees = 200, max_depth = 50)
h2o_gbm_lat_b1 <- h2o.randomForest(x = predictornames, y = 'LATITUDE', training_frame = h2o_train_bybuilding_list$`1`, 
                                   validation_frame = h2o_val_bybuilding_list$`1`, ntrees = 200, max_depth = 50)

h2o_gbm_fl_b2 <- h2o.randomForest(x = predictornames, y = 'FLOOR', training_frame = h2o_train_bybuilding_list$`2`, 
                                  validation_frame = h2o_val_bybuilding_list$`2`, ntrees = 200, max_depth = 50)
h2o_gbm_fl_b0 <- h2o.randomForest(x = predictornames, y = 'FLOOR', training_frame = h2o_train_bybuilding_list$`0`, 
                                  validation_frame = h2o_val_bybuilding_list$`0`, ntrees = 200, max_depth = 50)
h2o_gbm_fl_b1 <- h2o.randomForest(x = predictornames, y = 'FLOOR', training_frame = h2o_train_bybuilding_list$`1`, 
                                  validation_frame = h2o_val_bybuilding_list$`1`, ntrees = 200, max_depth = 50)

h2o_gbm_lon_b2 <- h2o.randomForest(x = predictornames, y = 'LONGITUDE', training_frame = h2o_train_bybuilding_list$`2`, 
                                   validation_frame = h2o_val_bybuilding_list$`2`, ntrees = 200, max_depth = 50)
h2o_gbm_lon_b0 <- h2o.randomForest(x = predictornames, y = 'LONGITUDE', training_frame = h2o_train_bybuilding_list$`0`, 
                                   validation_frame = h2o_val_bybuilding_list$`0`, ntrees = 200, max_depth = 50)
h2o_gbm_lon_b1 <- h2o.randomForest(x = predictornames, y = 'LONGITUDE', training_frame = h2o_train_bybuilding_list$`1`, 
                                   validation_frame = h2o_val_bybuilding_list$`1`, ntrees = 200, max_depth = 50)
